local ts = require("dullahan.treesitter")
...
function M.invert_color(color)
  local hsluv = require("dullahan.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("dullahan", { clear = true })
