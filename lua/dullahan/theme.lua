...
function M.setup()
  ...
  theme.highlights = {
    ...
    markdownCode = { fg = c.yellow500, bg = c.green200 },
    markdownCodeBlock = { fg = c.yellow500, bg = c.green200 },
    ...
    DiagnosticVirtualTextError = { bg = c.red100, fg = c.red500 }, -- Used for "Error" diagnostic virtual text
    DiagnosticVirtualTextWarn = { bg = c.yellow100, fg = c.yellow500 }, -- Used for "Warning" diagnostic virtual text
    DiagnosticVirtualTextInfo = { bg = c.blue100, fg = c.blue500 }, -- Used for "Information" diagnostic virtual text
    DiagnosticVirtualTextHint = { bg = c.cyan100, fg = c.cyan500 }, -- Used for "Hint" diagnostic virtual text
    ...
    ["@text.literal.markdown_inline"] = { fg = c.yellow500, bg = c.green200 },
    ...
    ["@text.warning"] = { fg = c.yellow100, bg = c.yellow500 },
    ["@text.danger"] = { fg = c.red100, bg = c.red500 },
    ...
    NeogitDiffDeleteHighlight = { fg = c.red500, bg = c.red100 },
    NeogitDiffAddHighlight = { fg = c.green500, bg = c.green200 },
